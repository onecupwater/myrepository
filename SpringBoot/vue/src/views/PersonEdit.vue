<template>
    <div>
        <el-card style="height: 20vh; margin: 25px 50px">
        ...
        <el-card style="height: 60vh; margin: 25px 50px; padding: 0 30px;">
                    ...
                    if(valid){
                        this.request.post("user/save",this.personForm).then(res=>{
                            if(res.code===200){
                                ...
                                let menus = this.personForm.menus;
                                this.newUser = res.data;
                                this.newUser.token = token;
                                this.newUser.menus = menus;
