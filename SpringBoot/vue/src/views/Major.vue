        ...
        <el-dialog title="专业信息" :visible.sync="dialogFormVisible" width="30%">
            <el-form :model="form" label-width="70px">
                ...
                <el-form-item label="指导老师">
                    <el-select clearable v-model="form.teacherId"
                               placeholder="请选择指导老师"
                               style="width: 100%">
    ...
    export default {
        ...
        methods: {
            load(){
                ...
                //找出所有老师姓名
                this.request.get("user/findAllTeachers").then(res=>{
                    if(res.code===200){
            ...
            deleteByBatchIds(){
                ...
                this.request.post("/major/removeBatchByIds",ids).then(res=>{
                    if(res.code===200){
            ...
            handleAdd(){
                if(!this.form.teacherId){
                    this.$message.warning("请选择指导老师");
                    return;
                }
                this.request.post("major/save",this.form).then(res=>{
                    if(res.code===200){
